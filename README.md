...
### Seiten
- `/dashboard` → Einstiegs-Dashboard mit Kacheln für Kicktipp und Kickbase plus kuratiertem News-Feed mit Stadionbildern.
...
- `/kickbase` → Kickbase-Dashboard mit Unterreitern Team, News (Stadion-Galerie + Alerts), Transfermarkt, Live-Punkte,
  Filterchips für Nation/Position, Vorlagen-Buttons pro Top-Team und einem 4-3-3 Pitch samt kuratiertem 12er-Pool.
